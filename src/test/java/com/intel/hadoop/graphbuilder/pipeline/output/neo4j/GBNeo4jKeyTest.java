...
import com.intel.hadoop.graphbuilder.pipeline.output.neo4j.GBNeo4jKey;
import org.junit.Test;

import static junit.framework.Assert.assertSame;

public class GBNeo4jKeyTest {

    @Test
    public void constructorSetGetTest() throws Exception {
        String   name        = "name";

        GBNeo4jKey key1 = new GBNeo4jKey(name);
        ...
        GBNeo4jKey key2 = new GBNeo4jKey(name, dataType, edgeIndex, vertexIndex, unique);
