...
/**
 * Contains the string constants for the Neo4j graph storage command line options.
 */
public class Neo4jCommandLineOptions {
    public static final String APPEND = "append";
    public static final String STORE = "neo4j";
