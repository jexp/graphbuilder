...
/**
 * An encapsulation of graphbuilder's view of a Neo4j key for indexing.
 * <p>Used in between parsing the command line and configuring Neo4j.</p>
 * @see Neo4jWriterMRChain
 */
public class GBNeo4jKey {
    ...
    /**
     * Constructs a new Neo4j key from a string name and sets the
     ...
     * </ul></p>
     * @param {@code name}  The name of the property being associated with this Neo4j key.
     */
    public GBNeo4jKey (String name) {
        this.name     = name;
    ...
    /**
     * Constructs a new Neo4j key with full specification of all fields - no default
     ...
     * @param {@code isUnique}
     */
    public GBNeo4jKey(String name, Class<?> dataType, boolean isEdgeIndex, boolean isVertexIndex, boolean isUnique) {
        this.name          = name;
    ...
    /**
     * Gets the name of the Neo4j key.
     * @return The name of the Neo4j key.
     */
    ...
    /**
     * Sets the name of the Neo4j key.
     * @param {@code name} The name of the Neo4j key to set.
     */
    ...
    /**
     * Gets the data type of the Neo4j key.
    ...
    /**
     * Sets the data type of the Neo4j key.
